...
import com.shopping.users.model.JWTAuthResponse;
...
public class UsersController {
	...
	public UsersController(UsersService usersService, PasswordEncoder passwordEncoder,
			UsernamePwdAuthenticationProvider usernamePwdAuthenticationProvider, JwtTokenProvider tokenProvider) {
		super();
	...
	@PostMapping("/login")
	public ResponseEntity<JWTAuthResponse> loginUser(@RequestBody AuthenticationRequest authRequest)
	{
